    ...
    <section className="bg-sfp-header py-20">
      <div className="max-w-[640px] mx-auto px-6">
        ...
        <div className="flex flex-wrap gap-x-10 gap-y-4 mb-14">
          <div>
            <p className="font-sans font-bold text-sfp-green text-4xl tracking-tight">8s</p>
            <p className="font-mono text-sfp-border text-xs mt-1">avg scan-to-decision</p>
          </div>
          <div>
            <p className="font-sans font-bold text-sfp-bg text-4xl tracking-tight">4 → 1</p>
            <p className="font-mono text-sfp-border text-xs mt-1">tools replaced</p>
          </div>
          <div>
            <p className="font-sans font-bold text-sfp-green text-4xl tracking-tight">1 photo</p>
        ...
        <div className="space-y-8 mb-12">
          {testimonials.map((t) => (
            <div key={t.handle} className="border-l-4 border-sfp-green pl-5">
              <p className="font-mono text-sfp-bg text-sm leading-relaxed mb-3">
                &ldquo;{t.quote}&rdquo;
              </p>
              <p>
                <span className="font-mono text-sfp-green text-sm">{t.handle}</span>
                <span className="font-mono text-sfp-muted text-xs ml-2">— {t.meta}</span>
              </p>
            </div>
          ))}
        </div>
        ...
        <div className="bg-sfp-surface rounded p-5">
          <p className="font-sans font-bold text-sfp-body text-sm mb-2">
        ...
        <p className="font-mono text-sfp-muted text-xs mt-10 text-center">
