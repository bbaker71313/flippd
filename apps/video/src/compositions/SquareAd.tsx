...
const Background: React.FC = () => (
  <AbsoluteFill>
    ...
    <AbsoluteFill style={{ backgroundColor: 'rgba(58,36,16,0.35)' }} />
  </AbsoluteFill>
);

// Scene 1: 0-60 — hook text + phone frame fading in
const Hook: React.FC = () => {
...
// Scene 2: 60-360 — phone frame (centered, 80px padding) + profit breakdown
        ...
        >
          <div
            style={{
              ...
              gap: brand.sm,
              backgroundColor: 'rgba(58,36,16,0.8)',
              padding: brand.lg,
