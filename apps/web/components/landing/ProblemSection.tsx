  ...
  return (
    <section className="bg-sfp-bg py-20">
      <div className="max-w-[640px] mx-auto px-6">
        <h2 className="font-sans font-bold text-sfp-body text-2xl sm:text-3xl leading-tight mb-6">
          You're running on vibes<br />and eBay searches.
        </h2>

        <p className="font-mono text-sfp-secondary text-sm leading-relaxed mb-6">
        ...
        <p className="font-mono text-sfp-secondary text-sm leading-relaxed mb-10">
        ...
        <div className="border-l-2 border-sfp-border pl-5 mb-10">
          <p className="font-mono text-sfp-muted text-xs uppercase tracking-widest mb-3">
            Sound familiar?
          </p>
          <ul className="font-mono text-sfp-secondary text-sm space-y-3">
        ...
        <div className="space-y-4 mb-12">
          <div className="bg-sfp-surface rounded-r border-l-4 border-sfp-warning px-5 py-4">
            <p className="font-sans font-semibold text-sfp-body text-sm mb-1">
              At the estate sale
            </p>
        ...
        <div className="border-t border-sfp-border pt-8">
          <p className="font-sans font-bold text-sfp-body text-xl leading-snug">
